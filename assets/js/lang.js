document.addEventListener("DOMContentLoaded", function () {
  const translations = {
    ...
    es: {
      ...
      paragraphs: [
        "Creemos que el diseño es una herramienta de cambio — y la estrategia es el terreno donde crece.",
        "Pensamos con claridad. Actuamos con intención. Perseguimos la calidad con disciplina, porque los detalles importan.",
        "Somos pensadores pragmáticos y solucionadores racionales de problemas. Cuestionamos, simplificamos y refinamos hasta que las cosas tienen sentido — y funcionan. Pero por encima de todo, somos apasionados. Entusiastas. Amamos lo que hacemos. Y lo hacemos con alegría.",
